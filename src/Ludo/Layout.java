    ...
    protected void paintComponent(Graphics g) {
       ...
       /* g.setColor(Color.YELLOW);
        ...
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 2; j++) {
                g.setColor(Color.YELLOW);
                g.fillArc(temp1 + (2 * i * width), temp2 + (2 * j * height), pieceWidth, pieceHeight, 0, 360);
                g.setColor(Color.GREEN);
                g.fillArc(temp1 + (2 * i * width) + 9 * width, temp2 + (2 * j * height) + 9 * height, pieceWidth, pieceHeight, 0, 360);
                g.setColor(Color.BLUE);
                g.fillArc(temp1 + (2 * i * width) + 9 * width, temp2 + (2 * j * height) + 0 * height, pieceWidth, pieceHeight, 0, 360);
                g.setColor(Color.RED);
                g.fillArc(temp1 + (2 * i * width) + 0 * width, temp2 + (2 * j * height) + 9 * height, pieceWidth, pieceHeight, 0, 360);
       ...
       /* g.drawRect(x + ((1) * width), y + (1 * height), 4 * width, 4 * height);
        ...
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 2; j++) {
                g.drawArc(temp1 + (2 * i * width), temp2 + (2 * j * height), pieceWidth, pieceHeight, 0, 360);
                g.drawArc(temp1 + (2 * i * width) + 9 * width, temp2 + (2 * j * height) + 9 * height, pieceWidth, pieceHeight, 0, 360);
                g.drawArc(temp1 + (2 * i * width) + 9 * width, temp2 + (2 * j * height) + 0 * height, pieceWidth, pieceHeight, 0, 360);
                g.drawArc(temp1 + (2 * i * width) + 0 * width, temp2 + (2 * j * height) + 9 * height, pieceWidth, pieceHeight, 0, 360);
            }
        }
